...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/TulipaEnergy/TulipaIO.jl
   ```
...
- After that runs, the [stable docs](https://TulipaEnergy.github.io/TulipaIO.jl/stable) should be updated. Check them and look for the version number.
